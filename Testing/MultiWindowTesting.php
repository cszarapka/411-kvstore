...
shell_exec("sh term.sh \"printf '\\e[8;18;95t';printf '\\e[3;0;0t';ssh -i ~/.ssh/id_rsa ubc_eece411_5@planet-lab2.cs.ucr.edu -t 'killall -9 java; java -jar testingClient.jar; bash'\"");
